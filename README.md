About pyiron_example_job-feedstock
==================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyiron_example_job-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5173&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyiron_example_job-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyiron_example_job` can be installed with `conda`:
...
```
mamba install pyiron_example_job
```

It is possible to list all of the versions of `pyiron_example_job` available on your platform with `conda`:
...
```
mamba search pyiron_example_job --channel conda-forge
```
...
mamba repoquery search pyiron_example_job --channel conda-forge

# List packages depending on `pyiron_example_job`:
mamba repoquery whoneeds pyiron_example_job --channel conda-forge

# List dependencies of `pyiron_example_job`:
mamba repoquery depends pyiron_example_job --channel conda-forge
```
